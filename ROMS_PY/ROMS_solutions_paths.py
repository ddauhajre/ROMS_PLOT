...
class ROMS_run(object):
    ...
    def set_paths(self):
        ...
        if self.ROMS_run_ID == 'L4PV':
           self.path_output = '/mnt/kamiya/dauhajre/Simulations/SCB/L4PV_new/'
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
        if self.ROMS_run_ID == 'L4_MidCal_SBC':

           self.path_output   = '/mnt/kamiya/dauhajre/Simulations/MidCal/L4/NO_WEC/Output/'
           self.path_grid = '/mnt/kamiya/dauhajre/Simulations/MidCal/L4/NO_WEC/Input/'
	   ...
	   self.nc_tstep        = 24
        ...
        if self.ROMS_run_ID == 'sbc4':
           #self.path_output = '/hun/dauhajre/Init_Bry_Temp/L4_Out/'
           self.path_output   = '/mnt/kamiya/dauhajre/Simulations/Nearshore_CA/SBC4/Output/'
           self.path_grid = '/mnt/kamiya/dauhajre/Simulations/Nearshore_CA/SBC4/Input/'
           #self.path_grid = '/hun/dauhajre/Init_Bry_Temp/'
           #self.path_frc  = '/hun/dauhajre/Init_Bry_Temp/'
           self.grid_name     = 'sbc4_grd.nc'
           self.out_base_name = 'sbc4nw_his.'
           
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
           self.nc_tstep        = 24


        if self.ROMS_run_ID == 'ptconc4':
           self.path_output   = '/mnt/kamiya/dhypolite/L4_ptSal_NOWEC/'
           self.path_grid = self.path_output
           self.path_frc  = '/hun/dauhajre/Init_Bry_Temp/'
           self.grid_name     = 'usw4_ptSal_nowec_his.0000.nc'
           self.out_base_name = 'usw4_ptSal_nowec_his.' 
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
           self.nc_tstep = 48

        if self.ROMS_run_ID == 'L3mag':
           self.path_output   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3mag_output/avg/'
           self.path_bgc   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3mag_output/bgc_avg/'
           self.path_kelp   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3mag_output/plant_his/'
           self.path_grid = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/Nest_Inputs/'
           self.path_z_kelp = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3mag_output/z_plant_his/'

           #self.path_frc  = '/hun/dauhajre/Init_Bry_Temp/'
           self.grid_name     = 'L3mag_grd.nc'
           self.out_base_name = 'L3mag_avg.' 
           self.out_bgc_name = 'L3mag_bgc_avg.'
           self.out_plant_name = 'L3mag_plant.'
           self.z_plant_name = 'z_L3mag_plant.'
           self.kelp_init = 'L3mag_kelp.nc'
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
           self.nc_tstep = 24 

        if self.ROMS_run_ID == 'L3magv2_test':
           self.path_output   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3magv2_test/avg/'
           self.path_bgc   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3magv2_test/bgc_avg/'
           self.path_kelp   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3magv2_test/plant_avg/'
           self.path_grid = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/Nest_Inputs/'
           #self.path_z_kelp = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L3mag_output/z_plant_his/'

           #self.path_frc  = '/hun/dauhajre/Init_Bry_Temp/'
           self.grid_name     = 'L3mag_grd.nc'
           self.out_base_name = 'L3magv2_test_avg.' 
           self.out_bgc_name = 'L3magv2_test_bgc_avg.'
           self.out_plant_name = 'L3magv2_test_plant_avg.'
           #self.z_plant_name = 'z_L3mag_plant.'
           self.kelp_init = 'L3mag_kelp.nc'
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
           self.nc_tstep = 24 
        ...
        if self.ROMS_run_ID == 'L2bgc':
           self.path_output   = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/L2_Y2000M06_AVG/'
           self.path_grid = '/mnt/kamiya/dauhajre/KELP_MODELING/MAG_Coupling_Test/Parent_Inputs/'
           
           #self.path_frc  = '/hun/dauhajre/Init_Bry_Temp/'
           self.grid_name     = 'l2_scb_grd.nc'
           self.out_base_name = 'l2_scb_avg.' 
           self.date_origin = datetime.datetime(1994,1,1,0,0,0,0)
           self.nc_tstep = 1 
        ...
        if self.ROMS_run_ID == 'L3_MidCal_30min':
           ...
           self.path_output   = '/mnt/kamiya/dauhajre/Simulations/MidCal/L3/NO_WEC/Output_30min/'
           self.path_grid = '/mnt/kamiya/dauhajre/Simulations/MidCal/L3/NO_WEC/Input/'
           #self.path_input = '/mnt/inca/akanc/MidCal/L3/02_input/winter2006/'
	   ...
	   self.nc_tstep        = 24
        ...
        if self.ROMS_run_ID == 'L2_MidCal_30min':
           ...
           self.path_output   = '/mnt/kamiya/dauhajre/Simulations/MidCal/L2/Output_30min/'
           self.path_grid = '/mnt/kamiya/dauhajre/Simulations/MidCal/L2/Input/'
           #self.path_input = '/mnt/inca/akanc/MidCal/L3/02_input/winter2006/'
	   ...
	   self.nc_tstep        = 24
        ...
        if self.ROMS_run_ID == 'L1_MidCal_30min_samp':

           self.path_output   = '/mnt/kamiya/dauhajre/Simulations/MidCal/L1/Output_30min/Sample_For_Part/'
           self.path_grid = '/mnt/kamiya/dauhajre/Simulations/MidCal/L1/Input/'
           #self.path_input = '/mnt/inca/akanc/MidCal/L3/02_input/winter2006/'
           self.grid_name     = 'usw1_grd_samp.nc'
           self.out_base_name = 'usw1_avg_samp.'
